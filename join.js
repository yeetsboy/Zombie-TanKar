...
class joinscene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(window.innerWidth / 2, 100, "Zombie TanKar", { fontFamily: "Mochiy Pop One", fontSize: 100, fill: "#00008B" }).setOrigin(0.5);

    this.button = this.add.rectangle(0, 0, 0, 0, 0x0f0);
    this.text = this.add.text(window.innerWidth / 2, window.innerHeight / 2.5, 'Play Zombie TanKar', { fill: '#ff0000', fontFamily: "Mochiy Pop One", fontSize: 50 }).setOrigin(0.5);
    ...
    this.text2 = this.add.text(window.innerWidth / 2, window.innerHeight / 1.8, 'Controls', { fill: '#ff0000', fontFamily: "Mochiy Pop One", fontSize: 50 }).setOrigin(0.5);
    ...
    this.text3 = this.add.text(window.innerWidth / 2, window.innerHeight / 1.4, 'Your Best Eliminations', { fill: '#ff0000', fontFamily: "Mochiy Pop One", fontSize: 50 }).setOrigin(0.5);
